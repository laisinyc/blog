...
2. **Internal CSS** (type prop is optional): `<head><style type='text/css'>css goes here</head>`
3. **External CSS**: `<link ref='stylesheet' type='text/css' href='yourstyle.css'>`

## CSS Specificity (256 进制)

CSS specificity follows this hierarchy:
...
Font icon implementation details would go here.
